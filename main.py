...
get/max):
  - 2026-08-15: /controls научилась set_strategy_cli.sh set (ручное
    ...
    человек делает через z0r пункт 12 -> 3, просто кнопкой вместо SSH,
...
def controls_strategy_set(
    ...
    """Ручное переключение стратегии -- то же самое, что z0r пункт 12 -> 3 или
...
def controls_autoupdate_toggle(
    ...
    /etc/z2r_autobench/autoupdate.conf, что читает и z0r пункт 14 -> 6 (см.
